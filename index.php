...
<body>
    ...
    <main>
        <section class="position-relative" id="home">
            ...
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active" style="background-image: url('assets/img/banners/bg-home.png')">
                        <div class="overlay"></div>
                        <div class="container d-flex align-items-center justify-content-center h-100 box-content-home">
                            <div class="row">
                                <div class="col-md-7">
                    ...
                    <div class="carousel-item" style="background-image: url('assets/img/banners/bg-home-2.png')">
                        <div class="overlay"></div>
                        <div class="container d-flex align-items-center justify-content-center h-100 box-content-home">
                            <div class="row">
                                <div class="col-md-7">
                    ...
                    <div class="carousel-item" style="background-image: url('assets/img/banners/bg-home-3.png')">
                        <div class="overlay"></div>
                        <div class="container d-flex align-items-center justify-content-center h-100 box-content-home">
                            <div class="row">
                                <div class="col-md-7">
        ...
        <section class="position-relative" id="contact"
            style="background-image: url('assets/img/banners/Rectangle10.png')">
            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-2">
                                <span class="icon-md text-white"><i class="fab fa-whatsapp"></i></span>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-2">
                                <span class="icon-md text-white"><i class="fas fa-phone-alt"></i></span>
                            </div>
                            <div class="col-md-10 pt-3 ">
                                <h4 class="font-weight-bolder text-white">
                                    Telefone
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <ul class="nav list-group" id="client-area-ul">
                            <li>
                                <p><span class="pr-3"><i class="fas fa-check-square"></i></span>Emitir boleto</p>
                            </li>
                            <li>
                                <p><span class="pr-3"><i class="fas fa-check-square"></i></span>Atendimento</p>
    ...
    <footer>
        <div class="container py-5">
            <div class="row">
                <div class="col-md-4">
                    <h1 class="text-white font-weight-bolder mb-5">
                        OneNet
                    </h1>
